 ...
 * @Description: 驱动工厂
 */
public class SnowDriverFactory {
    private static SnowDriverFactory instance;
    public static SnowDriverFactory getInstance() {
        if(instance==null) {
            instance = new SnowDriverFactory();
        }
        return instance;
    }
